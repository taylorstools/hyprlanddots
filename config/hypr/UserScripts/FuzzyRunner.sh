...
selected=$(fd . --hidden -tf -td --case-sensitive / | fzf --layout reverse --info hidden --border --query "/home/taylor/" --color "fg:#ffffff,fg+:$color13,selected-fg:$color13,selected-bg:#000000,bg:#000000,list-bg:#000000,border:$color13")
