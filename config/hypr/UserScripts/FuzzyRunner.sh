...
selected=$(fd . --hidden -tf -td --case-sensitive $HOME | fzf --layout reverse --info hidden --border --prompt "/home/taylor/" --bind 'ctrl-/:change-preview-window(50%|hidden|)' --color "fg:#ffffff,fg+:$color13,selected-fg:$color13,selected-bg:#000000,bg:#000000,list-bg:#000000,border:$color13")
